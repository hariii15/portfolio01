...
const DEFAULT_ITEMS = [
  {
    title: "React",
    description: "Beautiful typography for your projects.",
    id: 1,
  ...
  {
    title: "Django, Flask",
    description: "Functional and beautiful components for your projects.",
    id: 5,
    icon: <FiCode className="h-[16px] w-[16px] text-white" />,
  },
  {
    title: "Machine Learning",
    description: "Provides a great starting point for your projects.",
    id: 6,
    icon: <FiCode className="h-[16px] w-[16px] text-white" />,
  },
];
